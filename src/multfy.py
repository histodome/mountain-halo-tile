...
# 输出山体阴影图
# os.system("gdaldem hillshade -az 45 -z 1.5 'sichuan.tif' 'hillshade.tif'")
...
# 读取slope和relief
img_r = Image.open(r'/Users/duanqigeng/Desktop/gis_data/globle_relief.tif')
img_s = Image.open(r'/Users/duanqigeng/Desktop/gis_data/globle_slope.tif')

# 读取灰度山体阴影(灰度图)
img_h = cv2.imread(r'/Users/duanqigeng/Desktop/gis_data/globle_hillshade.tif', cv2.IMREAD_GRAYSCALE)
# 将灰度图转化为RGB
